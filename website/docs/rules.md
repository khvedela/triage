---
title: Rules
description: Complete built-in rules reference for triage.
slug: /rules
---

import DocHero from "@site/src/components/docs/DocHero";
import RulesCategoryNav from "@site/src/components/docs/RulesCategoryNav";

<DocHero
  eyebrow="Reference"
  title="Built-in rules, grouped as stable diagnostic surfaces."
  lede="Rules are the public diagnosis vocabulary of triage. They are designed to be readable in terminals, referenceable in runbooks, and stable enough for automation. The summary below is the quick index; the sections that follow explain each rule in more detail."
  meta={["Stable rule IDs", "Category-scoped navigation", "Docs links preserved"]} />
